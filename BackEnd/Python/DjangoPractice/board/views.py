...
def delete(request):
    ...
    if result:
        ...
        return HttpResponseRedirect('/board/deletealert')


def deletealert(request):
    return render(request, 'board/deletealert.html')


def search(request):
    kwd = request.POST['kwd']
    return HttpResponseRedirect('/board/searchlist?kwd='+kwd)
...
def searchlist(request):
    ...
    data = {'contenslist': contenslist}
    return render(request, 'board/searchlist.html', data)